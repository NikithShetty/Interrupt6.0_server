			...
			while($row=mysqli_fetch_assoc($result)){
				print"
					<div class='w3-container'>
						<a href='".WEB_HOST."/event_desc.php?event=".$row['event_name']."'>
							<div class='w3-card-4'>
								<div class='w3-row'>
									<img class='w3-round w3-col s12' src='".$row['img_url']."' alt='Norway'>
									<div class='w3-container w3-col s12 w3-center'>
										<p>".$row['event_name']."</p>
									</div>
								</div>
							</div>
